...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0E045F8B86
	for <lists+linux-pci@lfdr.de>; Tue, 12 Nov 2019 10:16:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727343AbfKLJQ2 (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Tue, 12 Nov 2019 04:16:28 -0500
Received: from mga12.intel.com ([192.55.52.136]:30221 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727312AbfKLJQZ (ORCPT <rfc822;linux-pci@vger.kernel.org>);
        Tue, 12 Nov 2019 04:16:25 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga106.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 12 Nov 2019 01:16:24 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.68,295,1569308400"; 
   d="scan'208";a="207049941"
Received: from black.fi.intel.com ([10.237.72.28])
  by orsmga003.jf.intel.com with ESMTP; 12 Nov 2019 01:16:19 -0800
Received: by black.fi.intel.com (Postfix, from userid 1001)
        id 94422214; Tue, 12 Nov 2019 11:16:17 +0200 (EET)
...
Subject: [PATCH v4 2/2] PCI: Add missing link delays required by the PCIe spec
Date:   Tue, 12 Nov 2019 12:16:17 +0300
Message-Id: <20191112091617.70282-3-mika.westerberg@linux.intel.com>
...
index 45f5c968b4fb..1f319b1175da 100644
--- a/drivers/pci/pci.c
+++ b/drivers/pci/pci.c
@@ -1012,14 +1012,11 @@ int pci_power_up(struct pci_dev *dev)
...
@@ -4643,6 +4640,124 @@ bool pcie_wait_for_link(struct pci_dev *pdev, bool active)
