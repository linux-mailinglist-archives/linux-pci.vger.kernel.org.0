...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C157D7C50FF
	for <lists+linux-pci@lfdr.de>; Wed, 11 Oct 2023 13:06:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234879AbjJKLGZ (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Wed, 11 Oct 2023 07:06:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54272 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234889AbjJKLGJ (ORCPT
        <rfc822;linux-pci@vger.kernel.org>); Wed, 11 Oct 2023 07:06:09 -0400
Received: from ex01.ufhost.com (ex01.ufhost.com [61.152.239.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0560CE7;
        Wed, 11 Oct 2023 04:05:36 -0700 (PDT)
Received: from EXMBX166.cuchost.com (unknown [175.102.18.54])
        (using TLSv1 with cipher DHE-RSA-AES256-SHA (256/256 bits))
        (Client CN "EXMBX166", Issuer "EXMBX166" (not verified))
        by ex01.ufhost.com (Postfix) with ESMTP id B4EA524E38A;
        Wed, 11 Oct 2023 19:05:34 +0800 (CST)
...
Subject: [PATCH v8 21/22] PCI: starfive: Add JH7110 PCIe controller
Date:   Wed, 11 Oct 2023 19:05:13 +0800
Message-ID: <20231011110514.107528-22-minda.chen@starfivetech.com>
...
---
 ...
 drivers/pci/controller/plda/pcie-plda-host.c | 135 +++++-
 drivers/pci/controller/plda/pcie-plda.h      |  94 +++-
 drivers/pci/controller/plda/pcie-starfive.c  | 448 +++++++++++++++++++
 6 files changed, 682 insertions(+), 15 deletions(-)
 create mode 100644 drivers/pci/controller/plda/pcie-starfive.c

diff --git a/MAINTAINERS b/MAINTAINERS
index 5426966c89c7..333774a65aa0 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -16677,6 +16677,13 @@ S:	Maintained
...
index 4f2e4827bbf9..187f082dba19 100644
...
@@ -351,7 +360,7 @@ static const struct plda_event_ops plda_event_ops = {
...
@@ -420,8 +429,7 @@ int plda_init_interrupts(struct platform_device *pdev,
...
@@ -438,8 +446,8 @@ int plda_init_interrupts(struct platform_device *pdev,
 		return ret;
 	}
...
@@ -463,26 +471,26 @@ int plda_init_interrupts(struct platform_device *pdev,
 		}
 	}
...
@@ -548,3 +556,102 @@ int plda_pcie_setup_iomems(struct pci_host_bridge *bridge,
 	return 0;
 }
...
index e0f8fd5ed46a..0cd057a89f00 100644
...
@@ -136,6 +152,11 @@ struct plda_event_ops {
...
+void __iomem *plda_pcie_map_bus(struct pci_bus *bus, unsigned int devfn, int where);
 int plda_init_interrupts(struct platform_device *pdev,
 			 ...
 			 const struct plda_event *event);
@@ -173,4 +202,67 @@ void plda_pcie_setup_window(void __iomem *bridge_base_addr, u32 index,
 			    size_t size);
