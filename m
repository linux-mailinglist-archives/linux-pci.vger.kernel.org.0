Return-Path: <linux-pci+bounces-13928-lists+linux-pci=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pci@lfdr.de
Delivered-To: lists+linux-pci@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 01CDA9923B1
	for <lists+linux-pci@lfdr.de>; Mon,  7 Oct 2024 06:44:07 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1F9221C211DA
	for <lists+linux-pci@lfdr.de>; Mon,  7 Oct 2024 04:44:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 004A481727;
	Mon,  7 Oct 2024 04:44:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="AncZFMIE"
X-Original-To: linux-pci@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BAC8F43ABC
	for <linux-pci@vger.kernel.org>; Mon,  7 Oct 2024 04:44:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1728276241; cv=none; b=DcZHPgswKlc/dAK/zBjg3ImQI9b+BbuzBtvtzLgQXtw95VXDQJ5hM98DKbgKYln/lQ1LzO2/puLoko+QyMrDAKVOuhzHL94FBPrL5uUT/zYm2E4U5h3Wn6Ap+nMvJPYipV74E1LJbRUFKce0jzdSzKbOu2eKqsU+NVSFQ3A66/0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1728276241; c=relaxed/simple;
	bh=5FqzYMBXsHJHqrYUCVw93WdvNtxgA7Ip3UwNDdQmIvU=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=NLgdyHQyi5fzjeGfMnzyjD/pISCNa308GJLi8r8KStCuVf25W1ZP7VfiCWbxJgJJe+rVis38aBu+p9yRqlbZCNU7kRjpuWpttG5rEjs+N9uMA+Jj96ggDCcK09GTj2KFImqBZR1xNHXxNKpukULKdL/aHyHkkKIEMIoBArTpxw8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=AncZFMIE; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B8A41C4CED1;
	Mon,  7 Oct 2024 04:43:59 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1728276241;
	bh=5FqzYMBXsHJHqrYUCVw93WdvNtxgA7Ip3UwNDdQmIvU=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [PATCH v1 4/5] PCI: endpoint: Add NVMe endpoint function driver
Date: Mon,  7 Oct 2024 13:43:50 +0900
Message-ID: <20241007044351.157912-5-dlemoal@kernel.org>
...
index c27f3190737f..c9b40621dbc1 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -16554,6 +16554,13 @@ S:	Supported
...
index 000000000000..16e01897e563
--- /dev/null
...
+	queue_delayed_work(cq->cmd_wq, &cq->work, 0);
...
+
+	cq->cmd_wq = alloc_workqueue("cq%d_wq", WQ_HIGHPRI, 1, qid);
+	if (!cq->cmd_wq) {
...
+
+	/*
+	 * Create the PCI controller admin submission and completion queues.
+	 */
...
+	schedule_delayed_work(&epf_nvme->ctrl.sq[sqid].work, 1);
+}
+
...
+		/*
+		 * Try to get commands from the host. If We do not have any
+		 * command yet, aggressively keep polling the SQ for at most
+		 * 1 ms and fall back to rescheduling the SQ work if we still
+		 * have not received any command after that. This hybrid
+		 * spin-polling method significantly increases the IOPS,
+		 * especially for shallow queue depth operation (e.g. QD=1).
+		 * Not that this is done only for I/O commands.
+		 */
...
+		schedule_delayed_work(&sq->work, poll_interval);
+	}
+}
+
+static void pci_epf_nvme_cq_work(struct work_struct *work)
...
+reschedule:
+	if (reschedule)
+		schedule_delayed_work(&cq->work, 1);
+}
+
