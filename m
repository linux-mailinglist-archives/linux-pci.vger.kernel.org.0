...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7A7333E579D
	for <lists+linux-pci@lfdr.de>; Tue, 10 Aug 2021 11:55:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233594AbhHJJ4Q (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Tue, 10 Aug 2021 05:56:16 -0400
Received: from mail.kernel.org ([198.145.29.99]:42998 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S239319AbhHJJ4L (ORCPT <rfc822;linux-pci@vger.kernel.org>);
        Tue, 10 Aug 2021 05:56:11 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id D617D610E9;
        Tue, 10 Aug 2021 09:55:48 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1628589349;
        bh=vl1U75sQ5caM4Sp3u9Y9KBEnSWRshD+R10rLD5IL6so=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: by mail.kernel.org with local (Exim 4.94.2)
        (envelope-from <mchehab@kernel.org>)
        id 1mDOU5-00AcFr-Ue; Tue, 10 Aug 2021 11:55:45 +0200
...
Subject: [PATCH v10 05/11] PCI: kirin: Add support for bridge slot DT schema
Date:   Tue, 10 Aug 2021 11:55:36 +0200
Message-Id: <5e586e136db61fa48a82cf96477ba607882af38a.1628589155.git.mchehab+huawei@kernel.org>
...
index 0ea92a521e1c..95962983e6f2 100644
...
@@ -347,11 +354,96 @@ static const struct regmap_config pcie_kirin_regmap_conf = {
 	.reg_stride = 4,
 };
...
+	int ret;
 	...
 	if (IS_ERR(apb_base))
@@ -362,7 +454,32 @@ static long kirin_pcie_get_resource(struct kirin_pcie *kirin_pcie,
...
@@ -419,9 +536,33 @@ static int kirin_pcie_wr_own_conf(struct pci_bus *bus, unsigned int devfn,
...
@@ -477,6 +618,44 @@ static int kirin_pcie_host_init(struct pcie_port *pp)
 	return 0;
 }
...
@@ -499,24 +678,43 @@ static int kirin_pcie_power_on(struct platform_device *pdev,
 		if (ret)
 			return ret;
