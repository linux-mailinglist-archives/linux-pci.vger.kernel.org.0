...
Subject: [PATCH v9 4/8] PCI/DPC: Add Error Disconnect Recover (EDR) support
Date:   Thu,  3 Oct 2019 16:39:00 -0700
Message-Id: <87ad0761e82ef58a1228693231cbdbd8d84cd74a.1570145778.git.sathyanarayanan.kuppuswamy@linux.intel.com>
...
@@ -103,6 +103,97 @@ int acpi_get_rc_resources(struct device *dev, const char *hid, u16 segment,
 }
 #endif
