...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1EE5E3E0523
	for <lists+linux-pci@lfdr.de>; Wed,  4 Aug 2021 18:03:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231661AbhHDQD0 (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Wed, 4 Aug 2021 12:03:26 -0400
Received: from mail.kernel.org ([198.145.29.99]:58926 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229812AbhHDQDX (ORCPT <rfc822;linux-pci@vger.kernel.org>);
        Wed, 4 Aug 2021 12:03:23 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 664F160FC4;
        Wed,  4 Aug 2021 16:03:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1628092990;
        bh=TD7KuVroHRtQkIQuRbN3Art6azt6K4SmklynaqnYWx0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: by mail.kernel.org with local (Exim 4.94.2)
        (envelope-from <mchehab@kernel.org>)
        id 1mBJMK-000Pzb-Hw; Wed, 04 Aug 2021 18:03:08 +0200
...
Subject: [PATCH v9 05/11] PCI: kirin: Add support for bridge slot DT schema
Date:   Wed,  4 Aug 2021 18:03:01 +0200
Message-Id: <2df8409f81767a33f7d4a5a79e28bb89f87f0abc.1628092716.git.mchehab+huawei@kernel.org>
...
---
 drivers/pci/controller/dwc/pcie-kirin.c | 266 +++++++++++++++++++++---
 1 file changed, 234 insertions(+), 32 deletions(-)

diff --git a/drivers/pci/controller/dwc/pcie-kirin.c b/drivers/pci/controller/dwc/pcie-kirin.c
index 0ea92a521e1c..9a6df034684e 100644
...
@@ -419,9 +540,33 @@ static int kirin_pcie_wr_own_conf(struct pci_bus *bus, unsigned int devfn,
...
@@ -477,6 +622,44 @@ static int kirin_pcie_host_init(struct pcie_port *pp)
 	return 0;
 }
...
@@ -499,24 +682,43 @@ static int kirin_pcie_power_on(struct platform_device *pdev,
 		if (ret)
 			return ret;
