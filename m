...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6D08C486723
	for <lists+linux-pci@lfdr.de>; Thu,  6 Jan 2022 16:55:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240783AbiAFPzS (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Thu, 6 Jan 2022 10:55:18 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48008 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240758AbiAFPzR (ORCPT
        <rfc822;linux-pci@vger.kernel.org>); Thu, 6 Jan 2022 10:55:17 -0500
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D9AB1C061245;
        Thu,  6 Jan 2022 07:55:16 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 72406B82254;
        Thu,  6 Jan 2022 15:55:15 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 04C32C36AE3;
        Thu,  6 Jan 2022 15:55:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1641484514;
        bh=3/JjCl/b4dH7CWdXSXMTGTFNWCV+HFB2frmcqgEHIyA=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=
Received: from sofa.misterjones.org ([185.219.108.64] helo=why.misterjones.org)
        by disco-boy.misterjones.org with esmtpsa  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
        (Exim 4.94.2)
        (envelope-from <maz@kernel.org>)
        id 1n5V6d-00GNij-Uz; Thu, 06 Jan 2022 15:55:12 +0000
Date:   Thu, 06 Jan 2022 15:55:11 +0000
Message-ID: <878rvsvoyo.wl-maz@kernel.org>
...
In-Reply-To: <20220106154447.aie6taiuvav5wu6y@pali>
...
> > >=20
> > > With this change, kernel can distinguish between INTA, INTB, INTC and=
 INTD
> > > interrupts.
> > >=20
> > > Note that for this support, device tree files has to be properly adju=
sted
> > > to provide "interrupts" or "interrupts-extended" property with intx
> > > interrupt source, "interrupt-names" property with "intx" string and a=
lso
> > > 'interrupt-controller' subnode must be defined.
> > >=20
> > > If device tree files do not provide these nodes then driver would wor=
k as
> > > before.
> > >=20
...
> > >  };
> > > =20
> > >  static inline void mvebu_writel(struct mvebu_pcie_port *port, u32 va=
l, u32 reg)
> > > @@ -235,7 +240,7 @@ static void mvebu_pcie_setup_wins(struct mvebu_pc=
ie_port *port)
> > > =20
...
> > > @@ -288,10 +293,30 @@ static void mvebu_pcie_setup_hw(struct mvebu_pc=
ie_port *port)
...
> > > +	irq_set_chip_and_handler(virq, &port->intx_irq_chip, handle_level_i=
rq);
