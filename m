...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C847238034C
	for <lists+linux-pci@lfdr.de>; Fri, 14 May 2021 07:22:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232566AbhENFXf (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Fri, 14 May 2021 01:23:35 -0400
Received: from mga12.intel.com ([192.55.52.136]:57612 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232508AbhENFXW (ORCPT <rfc822;linux-pci@vger.kernel.org>);
        Fri, 14 May 2021 01:23:22 -0400
IronPort-SDR: zagPb3P3kX4RnkjH1w44O/iDEUYVpCCHnEanUkELrMqk7Q3Z668pgY5RVwRkoSgkVTTNDEaWf8
 j0m57AJdqHRQ==
X-IronPort-AV: E=McAfee;i="6200,9189,9983"; a="179714439"
X-IronPort-AV: E=Sophos;i="5.82,299,1613462400"; 
   d="scan'208";a="179714439"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 May 2021 22:22:11 -0700
IronPort-SDR: z2I+W1C+1uZOjEsrqZQnr9T/KAlBLH2ihiDSboRK/yWHDwZMizvmxFe4jr9bzwyj8kpEFQOkKd
 hhSu+hAC3WwQ==
X-IronPort-AV: E=Sophos;i="5.82,299,1613462400"; 
   d="scan'208";a="538697217"
Received: from dwillia2-desk3.jf.intel.com (HELO dwillia2-desk3.amr.corp.intel.com) ([10.54.39.25])
  by fmsmga001-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 May 2021 22:22:10 -0700
Subject: [PATCH v4 5/8] cxl/acpi: Introduce ACPI0017 driver and cxl_root
From:   Dan Williams <dan.j.williams@intel.com>
To:     linux-cxl@vger.kernel.org
Cc:     Jonathan Cameron <Jonathan.Cameron@huawei.com>, hch@lst.de,
        linux-acpi@vger.kernel.org, linux-pci@vger.kernel.org,
        linux-kernel@vger.kernel.org
Date:   Thu, 13 May 2021 22:22:10 -0700
Message-ID: <162096973052.1865304.12885652112595883151.stgit@dwillia2-desk3.amr.corp.intel.com>
...
+Contact:        linux-cxl@vger.kernel.org
+Description:
+		(RO) Indicate whether the CXL address space supports
+		volatile memory targets. This file shows "1" if the
+		capability is supported, and is not present, or shows "0"
+		is the capability is not supported.
+
...
+Description:
+		(RO) Indicate whether the CXL address space supports
+		persistent memory targets. This file shows "1" if the
+		capability is supported, and is not present, or shows "0"
+		is the capability is not supported.
+
...
+Description:
+		(RO) Indicate whether the CXL address space supports
+		accelerator local memory targets. This file shows "1" if
+		the capability is supported, and is not present, or shows
+		"0" is the capability is not supported.
+
...
+Description:
+		(RO) Indicate whether the CXL address space supports
+		general purpose memory expander targets. This file shows
...
+Contact:        linux-cxl@vger.kernel.org
+Description:
+		(RO) A multi-ported host-bridge or CXL switch is tasked
+		with routing / decoding memory cycles received at the
+		upstream port to each downstream port. The CXL
+		Host-managed Device Memory (HDM) decoder programming
+		interface considers a target identifier in its
+		programming scheme. The 'target_id' attribute in sysfs
+		is an ordinal identifier of the given port identifying
