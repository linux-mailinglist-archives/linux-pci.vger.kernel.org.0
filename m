...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ED4D270D91D
	for <lists+linux-pci@lfdr.de>; Tue, 23 May 2023 11:34:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235981AbjEWJd7 (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Tue, 23 May 2023 05:33:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53992 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234889AbjEWJd5 (ORCPT
        <rfc822;linux-pci@vger.kernel.org>); Tue, 23 May 2023 05:33:57 -0400
Received: from szxga08-in.huawei.com (szxga08-in.huawei.com [45.249.212.255])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7C1C01A1;
        Tue, 23 May 2023 02:33:48 -0700 (PDT)
Received: from canpemm500009.china.huawei.com (unknown [172.30.72.54])
        by szxga08-in.huawei.com (SkyGuard) with ESMTP id 4QQTXt6RgRz18Lfs;
...
CC:     <alexander.shishkin@linux.intel.com>, <helgaas@kernel.org>,
        ...
        <linuxarm@huawei.com>
Subject: [PATCH v3 2/4] hwtracing: hisi_ptt: Add support for dynamically updating the filter list
Date:   Tue, 23 May 2023 17:32:26 +0800
Message-ID: <20230523093228.48149-3-yangyicong@huawei.com>
...
@@ -407,7 +520,8 @@ static int hisi_ptt_init_filters(struct pci_dev *pdev, void *data)
...
@@ -466,8 +580,13 @@ static int hisi_ptt_init_ctrls(struct hisi_ptt *hisi_ptt)
 	int ret;
 	u32 reg;
...
@@ -987,6 +1136,10 @@ static int hisi_ptt_probe(struct pci_dev *pdev,
 		return ret;
 	}
...
@@ -135,11 +143,24 @@ struct hisi_ptt_trace_ctrl {
