...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1EEF17D70D
	for <lists+linux-pci@lfdr.de>; Thu,  1 Aug 2019 10:18:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730229AbfHAISh (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Thu, 1 Aug 2019 04:18:37 -0400
Received: from mail-qk1-f171.google.com ([209.85.222.171]:46044 "EHLO
        mail-qk1-f171.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727956AbfHAISh (ORCPT
        <rfc822;linux-pci@vger.kernel.org>); Thu, 1 Aug 2019 04:18:37 -0400
Received: by mail-qk1-f171.google.com with SMTP id s22so51354256qkj.12;
        Thu, 01 Aug 2019 01:18:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :content-transfer-encoding;
        bh=UVZgjBhgS/B57QKBtnPjJMjzE+lhVtD1iQf5UcNcp7U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UVZgjBhgS/B57QKBtnPjJMjzE+lhVtD1iQf5UcNcp7U=;
        b=
X-Gm-Message-State: APjAAAUVipxsT1PlvmWi+0WZlPle3JCe//uWlRm0AUJ/L+rPkBI11+Wd
        Jat7Gn35CP/X91bBEERJwBYQWKrtLoYWoKnYzrEoFVYV
X-Google-Smtp-Source: APXvYqyCFs4BXVtd+0Rk01gSSWqj89jjCERITM50VvENEJ9d7Q+Sxu3i+i8EtKX9lQ2dtD8AXKqigs2ff0kna2Qw5uk=
X-Received: by 2002:ae9:eb87:: with SMTP id b129mr80930658qkg.453.1564647513640;
 Thu, 01 Aug 2019 01:18:33 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <CAGgoGu4zP_7QpKHiXSkLfkb=zHEezBzstVfjQMQ4CO60+YubCw@mail.gmail.com>
From:   Fawad Lateef <fawadlateef@gmail.com>
Date:   Thu, 1 Aug 2019 10:18:22 +0200
Message-ID: <CAGgoGu7rot61LSgu2syOMq9Onx26_u3PEtS7pf_QNQRxOaifhg@mail.gmail.com>
Subject: Unhandled fault: imprecise external abort (0x1406) when loading
...
[    0.003229] Mountpoint-cache hash table entries: 2048 (order: 1, 8192 by=
tes)
...
[    0.058858] DMA: preallocated 256 KiB pool for atomic coherent allocatio=
ns
...
[    0.150854] VFS: Dquot-cache hash table entries: 1024 (order 0, 4096 byt=
es)
[    0.167130] NET: Registered protocol family 2
[    0.168273] tcp_listen_portaddr_hash hash table entries: 512
(order: 0, 6144 bytes)
[    0.168336] TCP established hash table entries: 8192 (order: 3, 32768 by=
tes)
...
[    0.171954] hw perfevents: no interrupt-affinity property for /pmu, gues=
sing.
[    0.172349] hw perfevents: enabled with armv7_cortex_a9 PMU driver,
7 counters available
[    0.175261] Initialise system trusted keyrings
[    0.175573] workingset: timestamp_bits=3D30 max_order=3D19 bucket_order=
=3D0
...
[    0.185238] jffs2: version 2.2. (NAND) =EF=BF=BD=C2=A9 2001-2006 Red Hat=
, Inc.
...
[    0.199805] imx6q-pcie 1ffc000.pcie: Linked as a consumer to regulator.1=
2
[    0.199899] imx6q-pcie 1ffc000.pcie: host bridge /soc/pcie@1ffc000 range=
s:
...
[    0.420982] pci_bus 0000:00: root bus resource [mem 0x01000000-0x01effff=
f]
...
[    8.915070] ahci-imx 2200000.sata: SSS flag set, parallel bus scan disab=
led
...
[    9.086283] ci_hdrc ci_hdrc.1: new USB bus registered, assigned bus numb=
er 1
...
[    9.154230] da9063-rtc da9062-rtc: rtc core: registered da9063-rtc as rt=
c1
...
[    9.475356] caam 2100000.caam: device ID =3D 0x0a16010000000000 (Era 4)
...
[    9.753112] rtc-m41t80 0-0068: hctosys: unable to read the hardware cloc=
k
...
[   10.520393] usb 1-1.4.1: new full-speed USB device number 4 using ci_hdr=
c
...
Serial Device
[   10.762608] ftdi_sio 1-1.4.1:1.0: FTDI USB Serial Device converter detec=
ted
...
[   49.756484] random: dbus-uuidgen: uninitialized urandom read (12 bytes r=
ead)
[   49.763653] random: dbus-uuidgen: uninitialized urandom read (8 bytes re=
ad)
[   65.289080] urandom_read: 2 callbacks suppressed
[   65.289088] random: ssh-keygen: uninitialized urandom read (32 bytes rea=
d)
...
# /root/lsusb -v
# dmesg
[  573.066231] Unhandled fault: imprecise external abort (0x1406) at 0x0201=
2628
