...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3B5111A4C9E
	for <lists+linux-pci@lfdr.de>; Sat, 11 Apr 2020 01:24:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726687AbgDJXYp (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Fri, 10 Apr 2020 19:24:45 -0400
Received: from mga01.intel.com ([192.55.52.88]:57880 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726713AbgDJXYp (ORCPT <rfc822;linux-pci@vger.kernel.org>);
        Fri, 10 Apr 2020 19:24:45 -0400
IronPort-SDR: Pc3g2QQiyknRkbzfZAZpQX1hNlxlSXs1Kf1ebyfiKbyeECovyvcekjicbrEJlYRf6EAaA4LLRB
 AgLuebHpMVrQ==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Apr 2020 16:24:44 -0700
IronPort-SDR: s+PyQ4wm5RfxCAT1hgC6NTwgb9Jjo5P45lB9xwdbCC2EYeQT4Kvf/Bm7GpPrTS1ONbOMVTEglH
 QaOP0+6SsUoQ==
X-IronPort-AV: E=Sophos;i="5.72,368,1580803200"; 
   d="scan'208";a="426058868"
Received: from unknown (HELO arch-ashland-svkelley.intel.com) ([10.213.160.89])
  by orsmga005-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 10 Apr 2020 16:24:44 -0700
From:   Sean V Kelley <sean.v.kelley@linux.intel.com>
To:     mj@ucw.cz, bhelgaas@google.com
Cc:     linux-pci@vger.kernel.org,
        Sean V Kelley <sean.v.kelley@linux.intel.com>
Subject: [PATCH v3 2/2] lspci: Add basic decode support for Compute eXpress Link
Date:   Fri, 10 Apr 2020 16:24:40 -0700
Message-Id: <20200410232440.668057-3-sean.v.kelley@linux.intel.com>
X-Mailer: git-send-email 2.26.0
In-Reply-To: <20200410232440.668057-1-sean.v.kelley@linux.intel.com>
References: <20200410232440.668057-1-sean.v.kelley@linux.intel.com>
MIME-Version: 1.0
...
electrical and phyical interconnect for communication via a Flex Bus
...
+#define PCI_DVSEC_FLEXBUS_ID	0	/* Flex Bus feature capability ID */
+
...
index b82d37e..57f649c 100644
--- a/ls-ecaps.c
+++ b/ls-ecaps.c
@@ -634,6 +634,51 @@ cap_rclink(struct device *d, int where)
     }
 }
