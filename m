...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 69DE52A8B37
	for <lists+linux-pci@lfdr.de>; Fri,  6 Nov 2020 01:15:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732922AbgKFAPU (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Thu, 5 Nov 2020 19:15:20 -0500
Received: from mga12.intel.com ([192.55.52.136]:23050 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732905AbgKFAPU (ORCPT <rfc822;linux-pci@vger.kernel.org>);
        Thu, 5 Nov 2020 19:15:20 -0500
IronPort-SDR: rc2NZ5wpuK8YVhiqlmToa+6DvrSgl6gFTwL8355qZO6/CR6XY+HIi8yITClkLWYJrp3Tx2c1rY
 uuOYDuq8L7xA==
X-IronPort-AV: E=McAfee;i="6000,8403,9796"; a="148759552"
X-IronPort-AV: E=Sophos;i="5.77,454,1596524400"; 
   d="scan'208";a="148759552"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Nov 2020 16:15:18 -0800
IronPort-SDR: Upv/EKwHpXtA6NG5Io83tTW/dEDvcjIIA2MNfubJgdcgiMyOWDlrsCEdAdRfBSld5AEeSW53Lq
 wJ2gF9Iwjuhg==
X-IronPort-AV: E=Sophos;i="5.77,454,1596524400"; 
   d="scan'208";a="529621747"
Received: from gabriels-mobl1.amr.corp.intel.com (HELO arch-ashland-svkelley.intel.com) ([10.209.37.33])
  by fmsmga005-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 05 Nov 2020 16:15:18 -0800
...
Subject: [PATCH v10 14/16] PCI/AER: Add pcie_walk_rcec() to RCEC AER handling
Date:   Thu,  5 Nov 2020 16:14:42 -0800
Message-Id: <20201106001444.667232-15-sean.v.kelley@intel.com>
...
index 3498af81d240..8cabc74bfc8f 100644
...
+
 	...
 	if (!rpc)
 		return -ENOMEM;
@@ -1406,7 +1421,7 @@ static pci_ers_result_t aer_root_reset(struct pci_dev *dev)
