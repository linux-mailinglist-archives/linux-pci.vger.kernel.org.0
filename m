...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CA80F2FC787
	for <lists+linux-pci@lfdr.de>; Wed, 20 Jan 2021 03:13:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725842AbhATCLh (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Tue, 19 Jan 2021 21:11:37 -0500
Received: from regular1.263xmail.com ([211.150.70.204]:52050 "EHLO
        regular1.263xmail.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726707AbhATCK6 (ORCPT
        <rfc822;linux-pci@vger.kernel.org>); Tue, 19 Jan 2021 21:10:58 -0500
Received: from localhost (unknown [192.168.167.13])
        by regular1.263xmail.com (Postfix) with ESMTP id 30AC4570;
        Wed, 20 Jan 2021 09:58:51 +0800 (CST)
X-MAIL-GRAY: 0
X-MAIL-DELIVERY: 1
X-ADDR-CHECKED4: 1
X-ANTISPAM-LEVEL: 2
...
Received: from [192.168.31.83] (unknown [58.22.7.114])
        by smtp.263.net (postfix) whith ESMTP id P11934T140583509149440S1611107930590092_;
        Wed, 20 Jan 2021 09:58:51 +0800 (CST)
X-IP-DOMAINF: 1
X-UNIQUE-TAG: <1a0bc6555c3806be12c88caceb0bfbaf>
...
References: <20210118091739.247040-1-xxm@rock-chips.com>
 ...
 <70e62c12-807b-e673-6ae9-85699f5b3eb4@arm.com>
From:   xxm <xxm@rock-chips.com>
Message-ID: <76c82570-10ef-5790-2568-69e1ecc55b6f@rock-chips.com>
Date:   Wed, 20 Jan 2021 09:58:49 +0800
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:68.0) Gecko/20100101
 Thunderbird/68.12.1
MIME-Version: 1.0
In-Reply-To: <70e62c12-807b-e673-6ae9-85699f5b3eb4@arm.com>
...
Thanks for your review, all you mentioned will be fixed in next patch set

Simon Xue.

在 2021/1/20 4:28, Robin Murphy 写道:
...
>
> I believe you're meant to include linux/gpio/consumer.h rather than 
> any other GPIO-related header.
>
...
>> +};
>> +
>> +static inline int rockchip_pcie_readl_apb(struct rockchip_pcie 
>> *rockchip,
>> +                      u32 reg)
>> +{
...
>> +}
>> +
>> +static inline void rockchip_pcie_writel_apb(struct rockchip_pcie 
>> *rockchip,
>> +                        u32 reg, u32 val)
>> +{
...
>> +}
>> +
>> +static inline void rockchip_pcie_set_mode(struct rockchip_pcie 
>> *rockchip)
>> +{
...
>> +}
>> +
>> +static inline void rockchip_pcie_enable_ltssm(struct rockchip_pcie 
>> *rockchip)
>> +{
>> +    rockchip_pcie_writel_apb(rockchip, PCIE_CLIENT_GENERAL_CONTROL,
...
> don't mention devm_platform_ioremap_resource_byname() I'm sure 
> somebody else would come along and suggest it.
>
...
>> +    }
>
> Does the hardware require that the resets are deasserted in the 
> specific order of "whatever happens to be in the DT", or could you do 
> this much more simply with the reset_control_array APIs?
>
> Robin.
>
>> +
...
>> +}
>> +
>> +static void rockchip_pcie_fast_link_setup(struct rockchip_pcie 
>> *rockchip)
>> +{
>> +    u32 val;
>> +
...
>> +    val |= PCIE_LTSSM_ENABLE_ENHANCE | (PCIE_LTSSM_ENABLE_ENHANCE << 
>> 16);
>> +    rockchip_pcie_writel_apb(rockchip, PCIE_CLIENT_HOT_RESET_CTRL, 
>> val);
>> +}
>> +
>> +
