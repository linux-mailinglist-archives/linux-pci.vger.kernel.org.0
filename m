Return-Path: <linux-pci+bounces-9229-lists+linux-pci=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-pci@lfdr.de
Delivered-To: lists+linux-pci@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 307DD916702
	for <lists+linux-pci@lfdr.de>; Tue, 25 Jun 2024 14:11:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 51EC7B20763
	for <lists+linux-pci@lfdr.de>; Tue, 25 Jun 2024 12:11:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 10B0414D2B3;
	Tue, 25 Jun 2024 12:10:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ibm.com header.i=@ibm.com header.b="FAZJoKni"
X-Original-To: linux-pci@vger.kernel.org
Received: from mx0b-001b2d01.pphosted.com (mx0b-001b2d01.pphosted.com [148.163.158.5])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C2D3076033;
	Tue, 25 Jun 2024 12:10:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=148.163.158.5
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1719317457; cv=none; b=UbKfDcfrl4PF4C18ONOxDX2jg/Z9Mf0ZbBEdSoQlqxngeayb7dX+upEhd35M+zbdXqFMOjgggNumlG4c7YWdu9OrpGEYfLTSuy4b0XVnjRkfYvALe9rioE6AZVkPsAUu+tEkE2igm9lG6iQxJOimo5WgU1wTVZ9vtN6kobbaOCE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1719317457; c=relaxed/simple;
	bh=kjZTx0qTwFj5VARlT6OLkfs8DglDxsysCnSxGochJV8=;
	h=Message-ID:Date:MIME-Version:Subject:From:To:Cc:References:
	 In-Reply-To:Content-Type; b=kSJwIPGPP8rxv4naeLXAFEFmGLlPtMubcWFKOQ/qenjDM8Y/GwO5W0PeFXwDDYrDskFrxED9ivdMbeQ7AKxo7LC4MS5F5JpbrrcgTsu+M2Q5DwPGEygWAYS3ZvnZkh2KOusKGOAzhtd5XKruIElksFuXiyQAtBBTuXXETKcIVV8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=ibm.com; spf=pass smtp.mailfrom=ibm.com; dkim=pass (2048-bit key) header.d=ibm.com header.i=@ibm.com header.b=FAZJoKni; arc=none smtp.client-ip=148.163.158.5
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=ibm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ibm.com
Received: from pps.filterd (m0353723.ppops.net [127.0.0.1])
	by mx0a-001b2d01.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 45PBxN8Q006974;
	Tue, 25 Jun 2024 12:10:46 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=
	message-id:date:mime-version:subject:from:to:cc:references
	:in-reply-to:content-type:content-transfer-encoding; s=pp1; bh=k
	jZTx0qTwFj5VARlT6OLkfs8DglDxsysCnSxGochJV8=; b=FAZJoKniG3rCW1Fju
	
Received: from pps.reinject (localhost [127.0.0.1])
	by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 3yywggg0y0-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Tue, 25 Jun 2024 12:10:45 +0000 (GMT)
Received: from m0353723.ppops.net (m0353723.ppops.net [127.0.0.1])
	by pps.reinject (8.18.0.8/8.18.0.8) with ESMTP id 45PCAjCt024161;
	Tue, 25 Jun 2024 12:10:45 GMT
Received: from ppma23.wdc07v.mail.ibm.com (5d.69.3da9.ip4.static.sl-reverse.com [169.61.105.93])
	by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 3yywggg0xx-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Tue, 25 Jun 2024 12:10:45 +0000 (GMT)
Received: from pps.filterd (ppma23.wdc07v.mail.ibm.com [127.0.0.1])
	by ppma23.wdc07v.mail.ibm.com (8.17.1.19/8.17.1.19) with ESMTP id 45P8K4X3000685;
	Tue, 25 Jun 2024 12:10:44 GMT
Received: from smtprelay02.fra02v.mail.ibm.com ([9.218.2.226])
	by ppma23.wdc07v.mail.ibm.com (PPS) with ESMTPS id 3yxaemx56n-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Tue, 25 Jun 2024 12:10:44 +0000
Received: from smtpav05.fra02v.mail.ibm.com (smtpav05.fra02v.mail.ibm.com [10.20.54.104])
	by smtprelay02.fra02v.mail.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 45PCAcBa53215726
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
	Tue, 25 Jun 2024 12:10:40 GMT
Received: from smtpav05.fra02v.mail.ibm.com (unknown [127.0.0.1])
	by IMSVA (Postfix) with ESMTP id 9E1B320040;
	Tue, 25 Jun 2024 12:10:38 +0000 (GMT)
Received: from smtpav05.fra02v.mail.ibm.com (unknown [127.0.0.1])
	by IMSVA (Postfix) with ESMTP id 907FF20063;
	Tue, 25 Jun 2024 12:10:35 +0000 (GMT)
Received: from [9.171.67.31] (unknown [9.171.67.31])
	by smtpav05.fra02v.mail.ibm.com (Postfix) with ESMTP;
	Tue, 25 Jun 2024 12:10:35 +0000 (GMT)
Message-ID: <c08fd3f7-09c8-4af0-9921-455779659fc9@ibm.com>
Date: Tue, 25 Jun 2024 17:40:34 +0530
Precedence: bulk
...
Cc: Nathan Lynch <nathanl@linux.ibm.com>, Gaurav Batra
...
References: <20240514135303.176134-1-krishnak@linux.ibm.com>
 ...
 <a8bcbe65-362d-4856-8faa-9a761870bff8@ibm.com>
Content-Language: en-US
In-Reply-To: <a8bcbe65-362d-4856-8faa-9a761870bff8@ibm.com>
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: 8bit
X-TM-AS-GCONF: 00
X-Proofpoint-GUID: ttZv0JcYOSmm3MdyrrtS7dYvKLF2fzEe
X-Proofpoint-ORIG-GUID: 6zYbBwmmEMUXxUHDy-B_sYH8OFshqmfG
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 mlxlogscore=999 spamscore=0
 ...
 priorityscore=1501 adultscore=0 clxscore=1011 malwarescore=0 mlxscore=0
 suspectscore=0 classifier=spam adjust=0 reason=mlx scancount=1
 engine=8.19.0-2406140001 definitions=main-2406250088
...
I have uploaded patch version 3, and removed the DPC keyword from it. Did not do any
change in upstream port logic since driver does take care of this if the upstream port is
having slot property (explained above). 

Also I have left the check removal, since if I remove the check, the initialization for
non-bridge-port (i.e. for End-point) device happens multiple times (Verified with a nic card
having 4 ports). I have explained it below too.

It has been a while and I think we can merge this patch into mainline. I request to give
+1 on this.

These patch set will help Raptor Engineering team as well. They have done the testing with
these patch set. Two of the 3 bugs will be fixed by these patch set. And I am working towards
adding the NVME hot-plug support in this driver. At present link retraining does not happen
due to missing DPC support.
