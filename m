...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0EA15E83A4
	for <lists+linux-pci@lfdr.de>; Tue, 29 Oct 2019 09:58:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730163AbfJ2I6b (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Tue, 29 Oct 2019 04:58:31 -0400
Received: from mail-ot1-f65.google.com ([209.85.210.65]:41560 "EHLO
        mail-ot1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729904AbfJ2I6b (ORCPT
        <rfc822;linux-pci@vger.kernel.org>); Tue, 29 Oct 2019 04:58:31 -0400
Received: by mail-ot1-f65.google.com with SMTP id 94so9079240oty.8;
        Tue, 29 Oct 2019 01:58:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:in-reply-to:references:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=CAkL73E1mP9QSaoBYiNViJ8ObHFxf5lNejgcgvozahA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=CAkL73E1mP9QSaoBYiNViJ8ObHFxf5lNejgcgvozahA=;
        b=
X-Gm-Message-State: APjAAAVQ/livhCdSZTXgu1J15lpxujsC82ZGxIylTfKHq8SNZrJuJBRK
        FCt8MB71FC50iAO55UofYUw68sag4C9DeOOz6F4=
X-Google-Smtp-Source: APXvYqzqBF6aKFQ3+MPAWW8rkpW8kwM+mmUXlrfFGVDefT1Q4uxPk1TdkL/39DnjIOjbg8NuMmdPOGtS0zqMyalBrzY=
X-Received: by 2002:a9d:58c6:: with SMTP id s6mr16658968oth.215.1572339508329;
 Tue, 29 Oct 2019 01:58:28 -0700 (PDT)
MIME-Version: 1.0
Received: by 2002:a9d:648:0:0:0:0:0 with HTTP; Tue, 29 Oct 2019 01:58:27 -0700 (PDT)
In-Reply-To: <CAFjuqNit=Uf-q4hqgD88O5cxXaBNpXBkUP6nRnOUcSV+JwMB5Q@mail.gmail.com>
References: <20191020090800.GA2778@light.dominikbrodowski.net>
 ...
 <CAFjuqNiToDC9BSJVdahdkPz8Ejb-rM3VRkyoBNUTJr8go=7zrg@mail.gmail.com>
 <20191025075536.GA14531@owl.dominikbrodowski.net> <CAFjuqNit=Uf-q4hqgD88O5cxXaBNpXBkUP6nRnOUcSV+JwMB5Q@mail.gmail.com>
From:   "Michael ." <keltoiboy@gmail.com>
Date:   Tue, 29 Oct 2019 19:58:27 +1100
Message-ID: <CAFjuqNihuEb4_5Lny5X7vA258c0ogemVg8pQ5Y_ANgOsqhSXhg@mail.gmail.com>
...
>   CC [M]  drivers/net/wireless/realtek/rtlwifi/btcoexist/halbtc8192e2ant.=
o
>   CC [M]  drivers/net/wireless/realtek/rtlwifi/btcoexist/halbtc8723b1ant.=
o
>   CC [M]  drivers/net/wireless/realtek/rtlwifi/btcoexist/halbtc8723b2ant.=
o
>   CC [M]  drivers/net/wireless/realtek/rtlwifi/btcoexist/halbtc8821a1ant.=
o
>   CC [M]  drivers/net/wireless/realtek/rtlwifi/btcoexist/halbtc8821a2ant.=
o
...
>   LD [M]  drivers/net/wireless/realtek/rtlwifi/rtl8723com/rtl8723-common.=
o
...
> drivers/pci/quirks.c:631:7: error: =E2=80=98PCI_DEVICE_ID_SYNOPSYS_HAPSUS=
B3=E2=80=99
...
> =E2=80=98PCI_DEVICE_ID_SYNOPSYS_HAPSUSB3_AXI=E2=80=99 undeclared (first u=
se in this
> function); did you mean =E2=80=98PCI_DEVICE_ID_SUN_CASSINI=E2=80=99?
>   case PCI_DEVICE_ID_SYNOPSYS_HAPSUSB3_AXI:
>        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
>        PCI_DEVICE_ID_SUN_CASSINI
> drivers/pci/quirks.c:633:7: error: =E2=80=98PCI_DEVICE_ID_SYNOPSYS_HAPSUS=
B31=E2=80=99
> undeclared (first use in this function); did you mean
...
>        ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
>        PCI_DEVICE_ID_SUN_CASSINI
> drivers/pci/quirks.c: In function =E2=80=98quirk_disable_aspm_l0s=E2=80=
=99:
> drivers/pci/quirks.c:2229:2: error: implicit declaration of function
> =E2=80=98pci_disable_link_state=E2=80=99; did you mean =E2=80=98pci_resto=
re_iov_state=E2=80=99?
> [-Werror=3Dimplicit-function-declaration]
>   pci_disable_link_state(dev, PCIE_LINK_STATE_L0S);
>   ^~~~~~~~~~~~~~~~~~~~~~
>   pci_restore_iov_state
> drivers/pci/quirks.c:2229:30: error: =E2=80=98PCIE_LINK_STATE_L0S=E2=80=
=99 undeclared
> (first use in this function); did you mean =E2=80=98PCIE_LNK_WIDTH_RESRV=
=E2=80=99?
>   pci_disable_link_state(dev, PCIE_LINK_STATE_L0S);
>                               ^~~~~~~~~~~~~~~~~~~
>                               PCIE_LNK_WIDTH_RESRV
> drivers/pci/quirks.c: At top level:
> drivers/pci/quirks.c:4612:4: error: =E2=80=98PCI_VENDOR_ID_HXT=E2=80=99 u=
ndeclared
> here (not in a function); did you mean =E2=80=98PCI_VENDOR_ID_ATT=E2=80=
=99?
>   { PCI_VENDOR_ID_HXT, 0x0401, pci_quirk_qcom_rp_acs },
>     ^~~~~~~~~~~~~~~~~
>     PCI_VENDOR_ID_ATT
> drivers/pci/quirks.c:4633:4: error:
> =E2=80=98PCI_VENDOR_ID_AMAZON_ANNAPURNA_LABS=E2=80=99 undeclared here (no=
t in a
...
> =E2=80=98PCI_DEVICE_ID_NVIDIA_GEFORCE_320M=E2=80=99 undeclared (first use=
 in this
> function); did you mean =E2=80=98PCI_DEVICE_ID_NVIDIA_GEFORCE_6200=E2=80=
=99?
...
>>>  CC      drivers/pci/quirks.o
>>> drivers/pci/quirks.c:3039:1: error: expected identifier or =E2=80=98(=
=E2=80=99 before
>>> =E2=80=98-=E2=80=99
>>> token
>>>  3039 | -static void ricoh_mmc_fixup_rl5c476(struct pci_dev *dev)
>>>       | ^
>>> drivers/pci/quirks.c:3068:1: error: expected identifier or =E2=80=98(=
=E2=80=99 before
>>> =E2=80=98-=E2=80=99
>>> token
>>
