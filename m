...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 401AC301A3C
	for <lists+linux-pci@lfdr.de>; Sun, 24 Jan 2021 07:40:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726398AbhAXGk1 (ORCPT <rfc822;lists+linux-pci@lfdr.de>);
        Sun, 24 Jan 2021 01:40:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60112 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726369AbhAXGkQ (ORCPT
        <rfc822;linux-pci@vger.kernel.org>); Sun, 24 Jan 2021 01:40:16 -0500
Received: from mail-vs1-xe29.google.com (mail-vs1-xe29.google.com [IPv6:2607:f8b0:4864:20::e29])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B18ABC061573
        for <linux-pci@vger.kernel.org>; Sat, 23 Jan 2021 22:39:35 -0800 (PST)
Received: by mail-vs1-xe29.google.com with SMTP id o186so5481600vso.1
        for <linux-pci@vger.kernel.org>; Sat, 23 Jan 2021 22:39:35 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=tYwupBPdx9TejDmbhTlf54znMn7rYJIpp18eO1UD3CU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=tYwupBPdx9TejDmbhTlf54znMn7rYJIpp18eO1UD3CU=;
        b=
X-Gm-Message-State: AOAM533/H9eGpT7xB4J1Sb+wxHUJv3BqQXtY5tPUXfjHDjDWCTeZUPc+
        WCGsU3vcSdaIIQIeqZ+99tyoLzO9rLipe+puJokuPTYJ
X-Google-Smtp-Source: ABdhPJw7c1jDdQR1A1ZhmLJ8QwO5fuRWzhVCqptrOAwgMNCxquNAVS2PVhRfVV1cx2Kz3wLjeDMJ7ApuLEbqGPQuHCQ=
X-Received: by 2002:a67:5e86:: with SMTP id s128mr142813vsb.29.1611470374276;
 Sat, 23 Jan 2021 22:39:34 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CA+_S-OqAE5xoV=DFGJ=oOLrdfHEUVQ2d0tSyJ2Cksp5DGmAc7g@mail.gmail.com>
From:   =?UTF-8?B?SmFyaSBIw6Rtw6Rsw6RpbmVu?= <nuumiofi@gmail.com>
Date:   Sun, 24 Jan 2021 08:39:21 +0200
Message-ID: <CA+_S-Orc8EXHRexYVMfvQ0KSL2HBzWA2xhsPuAqGD7-syjYgrg@mail.gmail.com>
...
On Sat, Jan 2, 2021 at 3:43 PM Jari H=C3=A4m=C3=A4l=C3=A4inen <nuumiofi@gma=
il.com> wrote:
>
> On Fri, Jan 1, 2021 at 7:37 PM Bjorn Helgaas <helgaas@kernel.org> wrote:
> >
> > On Thu, Dec 31, 2020 at 02:52:12PM +0200, Jari H=C3=A4m=C3=A4l=C3=A4ine=
n wrote:
> > > Some PCIe devices cause Rockchip PCIe controller to crash in bus scan=
.
> > > Crash may be avoided by delaying bus scan by time given from command =
line
> > > or from device tree. Needed amount of delay varies from device to dev=
ice.
...
>
> This patch was not based on Rockchip erratum or other documentation. It w=
as
...
> Rockchip. Designware driver seems like a good place to start. I'm newbie =
in
...
> > > The following lists few problematic PCIe devices with delays needed f=
or
> > > stable bus scan surviving 100 sequential reboots in test loop execute=
d on
...
> > >
> > >   1) mpt3sas module has soft lockup bug on shutdown but device is usa=
ble
> > >   2) has infrequent crash on mpt3sas module load (2 of 662 reboots in=
 all
...
> > >
> > > Side effect of delay, if set, is that it slows down system startup by=
 the
> > > amount of delay.
> > >
...
> > most devices).
>
> This seems to be Rockchip-specific indeed. All devices above worked fine =
on
> x86-based setup.
>
...
> driver crashing on module load is a manifestation of same problem and cou=
ld
...
RockPro little cores with "maxcpus=3D4" parameter makes it crash with
synchronous abort:

  [    1.352923] Internal error: synchronous external abort: 96000210 [#1] =
SMP
...
5.11.0-rc4-nuumio-rkpcie2-00001-g331febe1a61 #1
  ...
  [    1.355281] pstate: 60000085 (nZCv daIf -PAN -UAO -TCO BTYPE=3D--)
...
reference:
  ...
  dm_pci_hose_probe_bus: bus =3D 1/pci_0:0.0
  pci_uclass_pre_probe, bus=3D1/pci_0:0.0, parent=3Dpcie@f8000000
...
debug with =E2=80=98dyndbg=3D"file drivers/pci/* +p; drivers/phy/rockchip/*=
 +p' I
...
interrupt received
  [   32.608369] Internal error: synchronous external abort: 96000210 [#1] =
SMP
  [   32.608395] rockchip-pcie f8000000.pcie: no fatal error interrupt rece=
ived
...
5.11.0-rc4-nuumio-rkpcie2-00001-g331febe1a61 #1
  ...
  [   32.612482] pstate: 80000005 (Nzcv daif -PAN -UAO -TCO BTYPE=3D--)
  [   32.613022] pc : megasas_readl+0x14/0x68 [megaraid_sas]
  [   32.613545] lr : megasas_read_fw_status_reg_fusion+0x18/0x28 [megaraid=
_sas]
...
[1] https://elixir.bootlin.com/linux/v5.11-rc4/source/drivers/pci/controlle=
r/cadence/pci-j721e.c#L420
[2] https://elixir.bootlin.com/linux/v5.11-rc4/source/drivers/pci/controlle=
r/dwc/pcie-tegra194.c#L1302
[3] https://elixir.bootlin.com/linux/v5.11-rc4/source/drivers/pci/controlle=
r/pci-aardvark.c#L256
[4] https://elixir.bootlin.com/linux/v5.11-rc4/source/drivers/pci/controlle=
r/pci-aardvark.c#L334
[5] https://community.intel.com/cipcp26785/attachments/cipcp26785/programma=
ble-devices/56074/1/cpci_power_on_timing.pdf
[6] http://opensource.rock-chips.com/images/e/ee/Rockchip_RK3399TRM_V1.4_Pa=
rt1-20170408.pdf
[7] https://elixir.bootlin.com/linux/v5.11-rc4/source/drivers/pci/controlle=
r/pcie-rockchip-host.c#L494
[8] https://lore.kernel.org/linux-pci/2a381384-9d47-a7e2-679c-780950cd862d@=
rock-chips.com/T/#u



> > > [    1.240653] CPU: 5 PID: 1 Comm: swapper/0 Not tainted 5.10.2-stabl=
e #1
...
> > > [    1.240759] Kernel panic - not syncing: Asynchronous SError Interr=
upt
> > > [    1.240763] CPU: 5 PID: 1 Comm: swapper/0 Not tainted 5.10.2-stabl=
e #1
...
> > > @@ -3823,6 +3823,14 @@
> > >               nomsi   Do not use MSI for native PCIe PME signaling (t=
his makes
> > >                       all PCIe root ports use INTx for all services).
> > >
> > > +     pcie_rockchip_host.bus_scan_delay_ms=3D
> > > +                     [PCIE] delay before PCIe bus scan in millisecon=
ds.
> > > +                     If set to greater than or equal to 0 this param=
eter will
> > > +                     override delay set in device tree. Values less =
than 0
> > > +                     are ignored. This parameter provides a workarou=
nd for
...
> > > +
> > >  static void rockchip_pcie_enable_bw_int(struct rockchip_pcie *rockch=
ip)
> > >  {
> > >       u32 status;
> > > @@ -941,6 +945,7 @@ static int rockchip_pcie_probe(struct platform_de=
vice *pdev)
...
> > >       if (!dev->of_node)
> > >               return -ENODEV;
> > > @@ -992,6 +997,19 @@ static int rockchip_pcie_probe(struct platform_d=
evice *pdev)
> > >       bridge->sysdata =3D rockchip;
> > >       bridge->ops =3D &rockchip_pcie_ops;
> > >
> > > +     /*
> > > +      * Work around a crash caused by some devices on bus scan by ap=
plying a
> > > +      * delay if one is given. Prefer command line value over device=
 tree.
> > > +      */
...
> > > @@ -149,6 +149,11 @@ int rockchip_pcie_parse_dt(struct rockchip_pcie =
*rockchip)
...
> > >  };
> > >
> > >  static u32 rockchip_pcie_read(struct rockchip_pcie *rockchip, u32 re=
g)
> > > --
> > > 2.29.2
> > >
